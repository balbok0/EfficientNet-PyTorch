...
def build_model(
    ...
    Args:
      ...
      fine_tuning: boolean, whether the model is used for fine-tuning.
    ...
    with tf.variable_scope(model_name):
        ...
        outputs = model(
            images, training=training, features_only=features_only, pooled_features_only=pooled_features_only
        )
    if features_only:
